...
function MagicButton({
    ...
    position: string; handelClick?: ()=> void; otherClasses?:string; 
}) {
    return (
        <div>
            <button className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10" onClick={handelClick}>
