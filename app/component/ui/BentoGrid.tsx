...
export const BentoGridItem = ({
  ...
  const handelCopy = () =>{
    navigator.clipboard.writeText('sakshamshankyan7@gmail.com')
    setCopied(true);
  }
  return (
    <div
        ...
        <div className={cn(
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:right-1">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-4 lg:mt-14">
                {/* flex flex-col gap-3 md:gap-3 lg:gap-4 lg:mt-14 */}
                {['Spring Boot', 'React.js', 'Next.ts'].map((item) => (
